...
@section('content')
    <div class="card-group" style="margin-top: 70px;">
                    ...
                    <div class="card border-primary mb-3" style="width: 14rem; height: 285px;">
                        ...
                        <div class="card-body text-primary">
                            ...
                            <ul id="S1" class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">TECH All</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card border-primary mb-3" style="width: 16rem; height: 285px;">
                        ...
                        <div class="card-body text-primary">
                            ...
                            <ul id="S1" class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">Class-IV HQ</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">    
                    <div class="card border-primary mb-3" style="width: 69rem;">
                        ...
                        <div class="card-body text-primary">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    <span>S2 - ENGG- Er. Kewal Krishan Reference Self </span> 
                                </li>
                                <li class="list-group-item">S2 - ENGG- Er. Gurmail Singh</li>
                                <li class="list-group-item">
                                    <span>S2 - ENGG-897 Er. Baljit Singh  Reference Self </span> 
                                </li>
                                @foreach($cases as $case)
                                    <li class="list-group-item">
                                     {{ $case->relates_to ." - " . $case->gpf . " - ". $case->name }}
                                    </li>
                                @endforeach 
                            </ul>
                        </div>
